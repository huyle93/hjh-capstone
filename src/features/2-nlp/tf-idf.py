...
# -*- coding: utf-8 -*-
"""
Created on Sun May 13 02:40:28 2018
...
#print('relevant score: ' + str(jaccard_similarity(tokenized_documents[2],tokenized_documents[4])))
#print('relevant score: ' + str(jaccard_similarity(tokenized_documents[1],tokenized_documents[6])))
